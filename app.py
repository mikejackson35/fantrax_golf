...
table = pd.merge(thru_cut,df_holes_remaining, left_index=True, right_index=True)
table = table.merge(team_score, left_index=True, right_index=True).rename(columns={'count':'Thru Cut','team':'Team','holes_remaining':'Holes Remaining','total':'Team Score'})
